...
const transSkidTruckOnlySchema = new Schema({
    ProjectID: {
        type: String,
        required: true
    },
...
const TransSkidTruckOnly = mongoose.model('TransSkidTruckOnly', transSkidTruckOnlySchema);

module.exports = TransSkidTruckOnly;